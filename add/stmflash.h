...
extern unsigned int FLASH_FLGS;
extern unsigned char ver;     //      remember to write
extern unsigned char isup;    // y 55 n ff
extern unsigned char toaddr;  // 1: ff 2:55
extern unsigned char isok;   //ok 55 err EE
